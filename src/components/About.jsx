        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '4rem', alignItems: 'center' }}>
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '1.1rem', background: 'var(--card-highlight-bg)', padding: '1.1rem 1.35rem', borderRadius: '1rem', border: '1px solid rgba(226, 232, 240, 0.85)' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '1.1rem', background: 'var(--card-highlight-bg)', padding: '1.1rem 1.35rem', borderRadius: '1rem', border: '1px solid rgba(226, 232, 240, 0.85)' }}>
                <div style={{ width: '10px', height: '10px', borderRadius: '50%', background: 'var(--color-primary-hover)', marginTop: '0.55rem', boxShadow: '0 0 10px var(--color-primary-light)', flexShrink: 0 }} />
                <p style={{ fontSize: '1.15rem', color: '#334155', lineHeight: 1.6 }}>
