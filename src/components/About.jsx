...
const About = () => {
  return (
    <section className="section" id="about" style={{
      ...
      background: 'radial-gradient(ellipse 80% 50% at 50% 100%, rgba(209, 250, 229, 0.3) 0%, rgba(255, 255, 255, 0) 70%)',
      position: 'relative'
    }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '4rem', alignItems: 'center' }}>
          ...
          <motion.div
            ...
            style={{
              ...
              padding: '2.5rem',
              boxShadow: '0 15px 35px rgba(16, 185, 129, 0.08), 0 2px 10px rgba(0,0,0,0.04)'
            }}
          >
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', background: 'rgba(209, 250, 229, 0.9)', border: '1px solid rgba(16, 185, 129, 0.35)', padding: '0.35rem 0.85rem', borderRadius: '9999px', marginBottom: '1.5rem' }}>
              <span style={{ width: '8px', height: '8px', borderRadius: '50%', background: '#059669', boxShadow: '0 0 10px rgba(5, 150, 105, 0.5)' }} />
              <span style={{ fontSize: '0.75rem', fontWeight: 700, letterSpacing: '0.06em', color: '#047857' }}>STEALTH STATUS: VERIFIED</span>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '1.1rem', background: '#f0fdf4', padding: '1.1rem 1.35rem', borderRadius: '1rem', border: '1px solid rgba(226, 232, 240, 0.85)' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '1.1rem', background: '#f0fdf4', padding: '1.1rem 1.35rem', borderRadius: '1rem', border: '1px solid rgba(226, 232, 240, 0.85)' }}>
                <div style={{ width: '10px', height: '10px', borderRadius: '50%', background: '#10b981', marginTop: '0.55rem', boxShadow: '0 0 10px rgba(16, 185, 129, 0.4)', flexShrink: 0 }} />
                <p style={{ fontSize: '1.15rem', color: '#334155', lineHeight: 1.6 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '1.1rem', background: '#f0fdf4', padding: '1.1rem 1.35rem', borderRadius: '1rem', border: '1px solid rgba(226, 232, 240, 0.85)' }}>
                <div style={{ width: '10px', height: '10px', borderRadius: '50%', background: '#047857', marginTop: '0.55rem', boxShadow: '0 0 10px rgba(4, 120, 87, 0.4)', flexShrink: 0 }} />
                <p style={{ fontSize: '1.15rem', color: '#334155', lineHeight: 1.6 }}>
          ...
          >
            ...
            >
              <img
                ...
                alt="Floating Cubes"
                style={{ width: '150px', height: 'auto', filter: 'drop-shadow(0 15px 25px rgba(16, 185, 129, 0.15))' }}
              />
            </motion.div>
